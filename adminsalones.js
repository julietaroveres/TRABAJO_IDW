...
function editarSalon(id) {
  ...
  if (salon) {
    ...
    document.getElementById('imagenSalon').value = salon.imagen;

    
    document.getElementById('formSalon').scrollIntoView({ behavior: 'smooth' });

    
    document.getElementById('nombreSalon').focus();
  }
}
    ...
    tr.innerHTML = `
      ...
      <img src="${salon.imagen}" alt="${salon.nombre}" style="width: 150px; height: auto;"></td>
       ...
       <td>
        ...
        <button onclick="editarSalon(${salon.id})" class="btn btn-sm btn-success me-2">Editar</button>
